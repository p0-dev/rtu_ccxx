...
/* =======================================================================================
  General Information
--------------------------------------------------------------------------------------- */
This project is intended to be used as base project for building other projects.
It will be tested with clang64 (MSYS).
...
[Name]  | [Note]
------------------------------------------------------------------------------------------
clang64 | - Distributor : MSYS
        | - URL         : https://packages.msys2.org/packages/mingw-w64-x86_64-clang
        | - Type        : LLVM C/C++ compiler
------------------------------------------------------------------------------------------
...
/* ***************************************************************************************
  THE END
>>>>>>> 233f15ec1784f2e0bf558ec5da06a1ec758054ab
******************************************************************************************